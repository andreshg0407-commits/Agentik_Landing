...
/**
 * scripts/integration/run-rbac-harness.ts
 *
 * AGENTIK-SECURITY-RBAC-01
 * HTTP client for the RBAC integration harness.
 *
 * Usage:
...
async function main(): Promise<void> {
  const url = `${BASE_URL}/api/internal/integration-tests/rbac`;

  console.log("═══════════════════════════════════════════════════════════════");
  console.log("  AGENTIK-SECURITY-RBAC-01 — Integration Harness");
  console.log("═══════════════════════════════════════════════════════════════");
  ...
  if (report.failed > 0) {
    ...
    console.log(`\n  ✓ ${report.passed}/${report.totalTests} PASS — RBAC Layer verified\n`);
  }
}
