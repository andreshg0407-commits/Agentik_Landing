/**
 * scripts/integration/run-executive-brain-harness.ts
 *
 * Agentik — Executive Brain — Integration Harness HTTP Client
 * Sprint: AGENTIK-EXECUTIVE-BRAIN-01 Phase 16
 *
 * Calls GET /api/internal/integration-tests/executive-brain
 ...
 *
 * Run:
 *   npx tsx scripts/integration/run-executive-brain-harness.ts
 */
...
const ENDPOINT = `${BASE_URL}/api/internal/integration-tests/executive-brain`;
...
async function main(): Promise<void> {
  console.log("═══════════════════════════════════════════════════════════════");
  console.log("  AGENTIK-EXECUTIVE-BRAIN-01 — Integration Harness");
