/**
 * POST /api/orgs/:orgSlug/copilot/approvals/:approvalId/reject
 *
 * Transitions a pending CopilotApprovalRequest to REJECTED.
...
export async function POST(req: NextRequest, { params }: Params): Promise<NextResponse> {
  ...
  try {
    ...
    const result = await svc.rejectApprovalRequest({
      approvalId,
      tenantId,
      resolvedBy,
      resolutionNote,
    ...
    console.error("[copilot/approvals/:approvalId/reject] POST error", err);
