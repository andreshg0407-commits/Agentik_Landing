/**
 * /[orgSlug]/agentik/marketing-studio/shopify
 * Shopify / Sistema — coming soon stub.
 */
...
export default async function ShopifyStudioPage({ params }: { params: Promise<{ orgSlug: string }> }) {
        ...
        <div style={{ display: "flex", alignItems: "center", gap: S[3] }}>
          <div>
            ...
            <div style={{ fontSize: T.sz.sm, color: C.inkLight, marginTop: 3 }}>
              Publica productos en Shopify directamente desde la Biblioteca Creativa.
            </div>
          </div>
      ...
      <Panel>
        <div style={{ padding: `${S[5]}px ${S[4]}px`, textAlign: "center" }}>
          ...
          <div style={{ color: C.inkLight, fontSize: T.sz.sm, maxWidth: 420, margin: "0 auto", lineHeight: 1.6, marginBottom: S[4] }}>
            Este módulo importará activos aprobados desde la Biblioteca Creativa y los publicará
            como borradores en Shopify, con título, descripción, precio, colores, tallas e inventario.
          </div>
          <div style={{ display: "flex", gap: S[2], justifyContent: "center", flexWrap: "wrap" }}>
            {["Título y descripción", "Precio y SKU", "Colores y tallas", "Inventario", "Destino Shopify"].map(f => (
